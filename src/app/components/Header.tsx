  ...
  return (
    ...
    <Box
      ...
      <Box className={styles.iconButtons}>
        ...
        <Button variant="text" size="small" className={styles.headerButtonColor}>
          <Link
            href={"/collection"}
        ...
        <Tooltip title="Cart" placement="bottom" arrow>
          <Button variant="text" size="small" aria-label="Cart" className={styles.headerButtonColor}>
            <Link
              href={"/cart"}
              aria-label="Cart"
              className={styles.headerSvgLink}
        ...
        <Button variant="text" size="small" aria-label="About" className={styles.headerButtonColor}>
        <Link
          href={"/about"}
          aria-label="About"
          className={styles.headerSvgLink}
        ...
        <Button variant="text" size="small" aria-label="Contact" className={styles.headerButtonColor}>
        <Link
          href={"/contact"}
          aria-label="Contact"
          className={styles.headerSvgLink}
